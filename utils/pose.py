# https://github.com/TRI-ML/packnet-sfm/blob/de53b310533ff6b01eaa23a8ba5ac01bac5587b1/packnet_sfm/geometry/pose.py
...
class Pose:
    ...
    @classmethod
    def from_vec(cls, vec, mode, invert=False):
        """Initializes from a [B,6] batch vector"""
        mat = pose_vec2mat(vec, mode, invert)  # [B,3,4]
    ...
    def transform_points(self, points):
        ...
        out = self.mat[:,:3,:3].matmul(points.view(B, 3, -1)) + \
